...
const Profile = ({ navigation }: NavigationProps) => {
  const refRBSheet = useRef<BottomSheetRef>(null);
    ...
    return (
      <View style={styles.profileContainer}>
        ...
        <Text
          style={[
            styles.title,
            { color: dark ? COLORS.secondaryWhite : COLORS.grayScale900 },
          ]}
        >
      ...
      >
        ...
        <View
          style={[
            styles.separateLine,
            {
              backgroundColor: dark ? COLORS.grayScale800 : COLORS.grayscale200,
            },
          ]}
        />
        <Text
